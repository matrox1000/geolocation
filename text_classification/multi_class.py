...
def train(train_dataset, model_file, epochs=3, batch_size=32):
    dfx = pd.read_csv(train_dataset)
...
if __name__ == "__main__":
    ...
    train("/root/dataset/train.csv", "/root/dataset/model_only_text.bin", epochs=3, batch_size=32)
    train("/root/dataset/train_categorical.csv", "/root/dataset/model_only_text_categorical.bin", epochs=3, batch_size=32)
    train("/root/dataset/train_removal.csv", "/root/dataset/model_only_text_removal.bin", epochs=3, batch_size=32)
   
    #preds = model.predict(valid_dataset, batch_size=32, n_jobs=-1)
    #for p in preds:
    #    print(p)
